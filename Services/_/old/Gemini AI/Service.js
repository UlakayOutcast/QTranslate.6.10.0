function serviceHeader() {
    return new ServiceHeader(96, "Gemini", "Google's AI Gemini as a professional translator." + Const.NL2 + "https://gemini.google.com/" + Const.NL2 + "\u00a9 Google", Capability.TRANSLATE)
}
