function serviceHeader() {
    return new ServiceHeader(85, "ClaudeAI", "Claude is a family of large language models developed by Anthropic." + Const.NL2 + "https://claude.ai/" + Const.NL2 + "\u00a9 Anthropic", Capability.TRANSLATE)
}
