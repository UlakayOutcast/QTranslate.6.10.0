function serviceHeader() {
    return new ServiceHeader(42, "Amazon", "Amazon Translate is a text translation service that uses advanced machine learning technologies to provide high-quality translation on demand. https://www.machinetranslation.com/ \u00a9 2023, Amazon Web Services", Capability.TRANSLATE)
}
...
SupportedLanguages = [-1, -1, "af", "az", "sq", "ar", "hy", "eu", "be", "bg", "ca", "zh", "zh-TW", "hr", "cs", "da", "nl", "en", "et", "fi", "tl", "fr", "gl", "de", "el", "ht", "he", "hi", "hu", "is", "id", "it", "ga", "ja", "ka", "ko", "lv", "lt", "mk", "ms", "mt", "no", "fa", "pl", "pt", "ro", "ru", "sr", "sk", "sl", "es", "sw", "sv", "th", "tr", "uk", "ur", "vi", "cy", "yi", "eo", "hmn", "la", "lo", "kk", "uz", "si", "tg", "te", "km", "mn", "kn", "ta", "mr", "bn", "tt"];
