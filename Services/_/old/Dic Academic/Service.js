function serviceHeader() {
    return new ServiceHeader(83, "Dic.academic", "Dictionaries and encyclopedias on Academician." + Const.NL2 + "https://dic.academic.ru/", Capability.DICTIONARY)
}

function serviceHost(a, b, c) {
    return "https://dic.academic.ru"
}
...
function serviceDictionaryResponse(a, b, c, e) {
	...
	b = b.replace(/href="\/searchall/g, 'href="'+serviceHost()+'/searchall');
...
function buildUri(a, b, c) {
    return "/searchall.php?from="+codeFromLanguage(c)+"&to=xx&did=&stype=&SWord=" + encodeGetParam(a)
};